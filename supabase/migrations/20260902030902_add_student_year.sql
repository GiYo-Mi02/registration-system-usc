...
alter table public.students
  drop constraint if exists students_year_not_blank;

alter table public.students
  add constraint students_year_not_blank
  check (year is null or btrim(year) <> '') not valid;

alter table public.students
  validate constraint students_year_not_blank;
